...
namespace QuanLyQuanCafe
{
    public partial class fTableManager : Form
    {
        ...
        public Account LoginAccount
        {
            ...
            set { loginAccount = value; ChangeAccountt(loginAccount.TypeAccount); }
        }
        ...
        void ChangeAccountt(int type)
        {
            admincmn.Enabled = type == 1;
        ...
        {
            fAccountFrofie f = new fAccountFrofie(LoginAccount);
        ...
        private void btnSưitchtable_Click(object sender, EventArgs e)
        {
